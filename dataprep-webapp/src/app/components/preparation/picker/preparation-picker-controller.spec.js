...
describe('Preparation Picker controller', () => {
    ...
    beforeEach(inject(($rootScope, $componentController) => {
        ...
        createController = () => {
            return $componentController('preparationPicker',
                {$scope: scope},
                {
                    closePicker: jasmine.createSpy('closePicker')
                });
        };
    }));
    ...
    describe('select a preparation', () => {
        it('should call application process function', inject(($q, PlaygroundService) => {
            ...
            //then
            expect(PlaygroundService.applyPreparationToDataset).toHaveBeenCalledWith(ctrl.selectedPreparation.id, ctrl.datasetId, ctrl.newPreparationName);
        }));
        ...
        it('should redirect to the new preparation', inject(($q, $state, PlaygroundService) => {
            ...
            //then
            expect(ctrl.closePicker).toHaveBeenCalled();
